...
────────────────────────────────────────────────────────────────────────────────
  ...
  Push your project to GitHub:
    ...
    gh repo create landmanbester/kremetart --public --source=. --push

  Or create the repo manually at https://github.com/new and push:

    git remote add origin git@github.com:landmanbester/kremetart.git
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Scroll down to "Add a new pending publisher" and fill in:
    PyPI project name: kremetart
    Owner:             landmanbester
    Repository:        kremetart
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/kremetart/settings/environments
...
────────────────────────────────────────────────────────────────────────────────
  ...
  a) Create the app:
     ...
     Settings:
       Name:        kremetart-bot (or any name you like)
       Homepage:    https://github.com/landmanbester/kremetart
  ...
  d) Add secrets to your repository:
     ...
     Go to: https://github.com/landmanbester/kremetart/settings/secrets/actions
...
────────────────────────────────────────────────────────────────────────────────
  ...
  Go to: https://github.com/landmanbester/kremetart/settings/rules
...
────────────────────────────────────────────────────────────────────────────────
  ...
  The container image is stored in src/kremetart/_container_image.py
  ...
  When you create a feature branch:
    ...
    1. Edit src/kremetart/_container_image.py and change the tag:

         CONTAINER_IMAGE = "ghcr.io/landmanbester/kremetart:my-feature"
